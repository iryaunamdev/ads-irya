...
for author in author_list:
    ...
    with open('data/author/'+author[0]+'.json') as json_file:
        papersA = json.load(json_file)
    if author[1]:
        with open('data/orcid/'+author[0]+'.json') as json_file:
    ...
    with open("data/consolidate_papers.json", "w", encoding='utf-8') as outfile:
